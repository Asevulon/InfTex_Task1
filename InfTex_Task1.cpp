...
// InfTex_Task1.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CInfTexTask1App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CInfTexTask1App

CInfTexTask1App::CInfTexTask1App()
{
...
// Единственный объект CInfTexTask1App

CInfTexTask1App theApp;


// Инициализация CInfTexTask1App

BOOL CInfTexTask1App::InitInstance()
{
